...
META_BOUNDS = {
    ...
    "tau":              (0.0,  0.95),
    "env_gain_spike":   (0.0005, 0.15),  # V8.7 : élargi de 0.08 → 0.15
...
def eval_individu_val(ind):
    """
    V8.7 — Validation croisée sur seeds jamais vues.
...
nb_gen       = 40   # V8.7 : doublé de 20 → 40
pop_size     = 50
n_elites     = 3
n_immigrants = 3
...
print("⚡ Lancement du Protocole Landauer V8.7")
...
for gen in range(nb_gen):
    ...
    # V8.7 — Validation croisée périodique sur les meilleurs individus
